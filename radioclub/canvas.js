...
function setup() {
  ...
  // createCanvas(size - (cellSize/2), (size - (cellSize/2)));
  createCanvas(size - (cellSize/2), ((size - (cellSize/2))/100 * 51)-(cellSize/2));
  // noLoop(); 
  // noCanvas();
  ...
  // let chatBtn = createButton('submit');
  // chatBtn.style('position', 'fixed');
  // chatBtn.style('top', '0');
  // chatBtn.style('right', '0');
  // chatBtn.style('z-index', '5');
  // chatBtn.mousePressed(greet);
}
